    ...
    <form method="POST">
        <table border="1" cellpadding="20px" align="center">
            ...
            <tr>
                ...
                <td><input type="radio" name="seat" value="Aisle">Side
...
echo ".................................<br>";
echo 'Press <a href="a2display.php" style="text-decoration:none;margin:10px;display:inline-block;border:1px solid black;">GO</a> again to view cookies';
